...
// Scopes : OpenID Connect + posting sur le profil personnel.
// NOTE : r_member_social (lecture des posts) requiert l'approbation
// "Marketing Developer Platform" de LinkedIn — pas accessible aux apps
// standard. On reste sur les scopes basiques pour que l'auth marche.
