...
import { CheckSquare, Square, Clock, Plus, Filter } from 'lucide-react';
    ...
    <main className="p-6 md:p-10 lg:p-12 max-w-5xl mx-auto">
      <div className="mb-10 flex items-end justify-between">
        <div>
          ...
          <p className="text-white/60 mt-2">{todos.filter(t => !t.done).length} en cours, {todos.filter(t => t.done).length} terminées</p>
        </div>
        ...
        {visible.map((t) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className={`font-medium ${t.done ? 'line-through text-white/40' : ''}`}>{t.title}</div>
