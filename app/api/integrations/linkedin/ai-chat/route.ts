...
import { streamAssistant, ChatMessage } from '@/lib/ai/linkedinAssistant';

export const runtime = 'nodejs';
export const maxDuration = 60; // Vercel — extend timeout for streaming + tool loop

/**
 * POST /api/integrations/linkedin/ai-chat
 * Body: { messages: ChatMessage[] }
 * Stream Server-Sent Events with the assistant's response.
 * Each SSE event is a JSON-encoded StreamEvent (type: text/tool_use/tool_result/done/error).
 */
