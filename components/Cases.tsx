...
const cases: CaseStudy[] = [
  ...
  },
  {
    ...
    result: '80k → 400k € / mois en 6 mois',
    ...
    context: "Agence immobilière francophone basée à Business Bay (Dubai), spécialisée dans l'accompagnement d'investisseurs francophones sur le marché émirati. Expertise solide mais visibilité digitale à construire pour asseoir l'autorité de la marque et accélérer l'acquisition.",
    duration: '6 mois',
    services: ['Branding & positionnement', 'Production de contenu', 'Relations médias', 'Social Media', 'Acquisition'],
    story: [
      ...
      "Mise en place d'une machine de contenu axée expertise marché (analyses, coulisses des projets, témoignages investisseurs) pour nourrir l'autorité de la marque et générer des leads qualifiés en continu.",
      "Stratégie de relations médias : SOPRA a été couverte par Forbes, BFM Business et C News — une visibilité qui ancre durablement la crédibilité de l'agence. Résultat : un chiffre d'affaires mensuel passé de 80k à 400k € en 6 mois.",
    ],
    metrics: [
      { value: 'x5', label: 'CA mensuel', sub: '80k → 400k €/mois' },
      { value: '6 mois', label: 'Durée', sub: 'pour x5 le CA' },
      { value: 'Forbes', label: 'Couverture média', sub: 'Forbes · BFM · C News' },
      { value: '400k€', label: 'CA mensuel actuel', sub: 'vs 80k au départ' },
    ],
    quote: {
      text: "On est passés de 80k à 400k € par mois. Et Omniscale nous a ouvert les portes des médias.",
